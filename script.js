    ...
    function renderActivities() {
      ...
      out.innerHTML = list.map(a => `
        <div style="margin-bottom:22px;padding-bottom:18px;border-bottom:1px dashed var(--border);">
          ...
          ${a.image ? `<img src="${a.image}" alt="Journal photo for ${a.date}" style="width:100%;height:auto;border-radius:8px;display:block;margin:0 0 12px;cursor:zoom-in;" onclick="window.open(this.src, '_blank')">` : ''}
